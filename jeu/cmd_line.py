...
def cmd_line():
    ...
    parser.add_argument('--fps', type= int, help= 'The number of frames per second to use with pygame', default=50)
    parser.add_argument('-W','--width', type=int, help='The width of the pygame screen', default=400)
    parser.add_argument('-H', '--height', type=int, help='The height of the pygame screen', default=400)
    parser.add_argument('--cell_size', type = int, help= 'The size of a cell', default=4)
