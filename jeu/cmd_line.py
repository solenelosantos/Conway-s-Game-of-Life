...
def cmd_line():
    ...
    parser.add_argument('-i', '--input_file', type=Path, help="Set the path to the initial pattern file", default="my_input_file.txt")
    ...
    parser.add_argument('-f', type= int, help= 'The number of frames per second to use with pygame', default=10)
