...
def cmd_line():
    ...
    parser.add_argument('-W','--width', type=int, help='The width of the pygame screen', default=200)
    parser.add_argument('-H', '--height', type=int, help='The height of the pygame screen', default=200)
